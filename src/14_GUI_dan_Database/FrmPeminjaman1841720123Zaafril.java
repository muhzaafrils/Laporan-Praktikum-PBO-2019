...
public class FrmPeminjaman1841720123Zaafril extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman
     */
    public FrmPeminjaman1841720123Zaafril() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData(){
        ...
        ArrayList<Peminjaman1841720123Zaafril> list = new Peminjaman1841720123Zaafril().getAll();
    ...
    public void cariAnggota(String keyword){
        Anggota1841720123Zaafril anggota = new Anggota1841720123Zaafril().getById(Integer.parseInt(keyword));
        jLabel6.setText("Nama Anggota : "+anggota.getNama());
    }
    
    public void cariBuku(String keyword){
        Buku1841720123Zaafril buku = new Buku1841720123Zaafril().getById(Integer.parseInt(keyword));
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        Peminjaman1841720123Zaafril pmj = new Peminjaman1841720123Zaafril();
        pmj.setIdpeminjaman(Integer.parseInt(txtIdPeminjaman.getText()));
        
        Anggota1841720123Zaafril anggota = new Anggota1841720123Zaafril().getById(Integer.parseInt(txtIdAnggota.getText()));
        Buku1841720123Zaafril buku = new Buku1841720123Zaafril().getById(Integer.parseInt(txtIdBuku.getText()));
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720123Zaafril pmj = new Peminjaman1841720123Zaafril().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pmj.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1841720123Zaafril.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720123Zaafril().setVisible(true);
            }
        });
    }
