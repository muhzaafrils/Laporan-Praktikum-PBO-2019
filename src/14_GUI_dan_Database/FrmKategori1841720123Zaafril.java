...
public class FrmKategori1841720123Zaafril extends javax.swing.JFrame {
     ...
     */
    public FrmKategori1841720123Zaafril() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmKategori1841720123Zaafril.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmKategori1841720123Zaafril().setVisible(true);
            }
        });
    }
